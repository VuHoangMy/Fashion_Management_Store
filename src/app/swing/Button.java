...
public class Button extends JButton {
    ...
    public void setBackgroundColorTop(Color backgroundColor){
        this.backgroundColorTop = backgroundColor;
    }
    ...
    public void setBackgroundColorBottom(Color backgroundColor){
    ...
    private Color backgroundColorTop = new Color(255, 255, 255, 10);
    private Color backgroundColorBottom = new Color(255, 255, 255, 100);
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        g2.setPaint(new GradientPaint(0, 0, this.backgroundColorTop, 0, height, this.getBackgroundColorBottom()));
